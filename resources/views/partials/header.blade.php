<div class="img-header-date relative dark-text">
    ...
    <div id="wedding-date" class="flex flex-col justify-end items-center">
        <h2 id="wedding-date-text" class="sm:text-4xl font-bold dark-text text-2xl">{{ $date->format('d') }} • {{ $date->format('m') }} • {{ $date->format('Y') }}</h2>
        <h1 class="dark-text sm:text-4xl text-center text-2xl">ALEXANDRA & CARLOS</h1>
